...
namespace Maxmind
{
    ...
    "MF"};
        ...
        public LookupService(Stream stream, int options)
        {
            try
            {
                this.file = stream;
            ...
            {
                Trace.WriteLine("cannot initialize lookup service");
                // Console.Write("cannot initialize lookup service");
            }
        }

        public LookupService(Stream stream)
            : this(stream, GEOIP_STANDARD)
        {
        }
