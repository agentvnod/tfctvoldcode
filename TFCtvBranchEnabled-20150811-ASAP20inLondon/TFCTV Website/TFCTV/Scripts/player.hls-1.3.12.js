        ...
        clip:
                {
                    ...
                    urlResolvers: params.urlResolvers,
                    url: params.url
					...
					{
					    time: 0,
					    adTagUrl: encodeURIComponent("http://ad3.liverail.com/?LR_PUBLISHER_ID=1331&LR_CAMPAIGN_ID=229&LR_SCHEMA=vast2")
					}
                    ]
                },
        showErrors: false,
        ...
        plugins:
                {
                    ...
                    , dfp: {
                        url: "http://az332173.vo.msecnd.net/swf/bigsool.dfp.hls-tfc.tv-3.0.swf"
                    }
                    //, akamai: params.apObj                     
                    , httpstreaming: {
