...
tfc.Social = function () {
    ...
    //    }
    //    gigya.services.socialize.addEventHandlers({ onConnectionAdded: obj.onConnectionAdded, onLogout: obj.onLogout, onLogin: obj.onConnect });
    return obj;
}

tfc.Social.EditConnectionsUI = function (params) {
    var obj = {};
    gigya.services.socialize.showEditConnectionsUI({
...
tfc.Social.ShowActivityFeed = function (params) {
    var obj = {};
    gigya.services.socialize.showFeedUI({
        containerID: params.container,
        width: '500'
    });
}
...
tfc.Social.ChatUI = function (params) {
    ...
    gigya.services.socialize.addEventHandlers({ onLogout: obj.onLogout, onLogin: obj.onConnect });
    gigya.services.socialize.showChatUI(params);
}
...
tfc.Social.PublishUserAction = function (params) {
    ...
    gigya.services.socialize.publishUserAction(action);
}
...
tfc.Social.Login = function (params) {
    ...
    if (params.isLogin == undefined || params.isLogin == false) {
        ...
        gigya.services.socialize.addEventHandlers({ onConnectionAdded: obj.onConnectionAdded, onLogout: obj.onLogout });
    }
    //if (params.addHandler)
    return obj;
    //gigya.services.socialize.addEventHandlers({ onLogin: obj.onLoginHandler });
}
...
tfc.Social.ShowFriendSelectorUI = function (params) {
    ...
    gigya.services.socialize.showFriendSelectorUI({
        containerID: params.container,
        width: params.width,
        height: params.height,
        enabledProviders: params.enabledProviders,
