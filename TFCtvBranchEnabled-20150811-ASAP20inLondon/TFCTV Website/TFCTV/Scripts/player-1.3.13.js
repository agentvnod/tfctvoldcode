...
flow.Player.Create = function (params) {
    ...
    logPlayback = function (type, id, playTypeId, fullDuration, isPreview, positionDuration, streamType) {
        $.post('/Ajax/LogPlayback', { type: type, id: id, playTypeId: playTypeId, fullDuration: Math.round(fullDuration), isPreview: isPreview, positionDuration: Math.round(positionDuration), streamType: streamType }, function (data) { console.log(data.StatusCode); });
    }
    ...
    flowplayer(params.container, {
        src: params.playerSWF, wmode: 'opaque', version: [10, 1],
        ...
        clip:
                {
                    ...
                    onPause: function () {
                        trackEvent('Videos', 'video-pause', buildTrackingLabel(params.label, params.isClip));
                        streamComscore.notify(ns_.StreamSense.PlayerEvents.PAUSE, {}, ((typeof this.getTime() != 'undefined') ? this.getTime() : 0));
                    },
                    onResume: function () {
                        trackEvent('Videos', 'video-resume', buildTrackingLabel(params.label, params.isClip));
                        streamComscore.notify(ns_.StreamSense.PlayerEvents.PLAY, { ns_st_ui: "resume" }, ((typeof this.getTime() != 'undefined') ? this.getTime() : 0));
                    },
                    onStop: function () {
                        trackEvent('Videos', 'video-stop', buildTrackingLabel(params.label, params.isClip));
                        streamComscore.notify(ns_.StreamSense.PlayerEvents.END, { ns_st_ui: "stop" }, ((typeof this.getTime() != 'undefined') ? this.getTime() : 0));
                    },
                    ...
                    onFinish: function () {
                        ...
                        streamComscore.notify(ns_.StreamSense.PlayerEvents.END, {}, ((typeof this.getTime() != 'undefined') ? this.getTime() : 0));
                    },
                    onBufferEmpty: function () { streamComscore.notify(ns_.StreamSense.PlayerEvents.BUFFER, { ns_st_ui: "buffer" }, ((typeof this.getTime() != 'undefined') ? this.getTime() : 0)); },
                    onBufferFull: function () { streamComscore.notify(ns_.StreamSense.PlayerEvents.PLAY, { ns_st_ui: "buffer_resume" }, ((typeof this.getTime() != 'undefined') ? this.getTime() : 0)); },
