...
function pc(data) {
    $(function () {
        ...
        jwp = jwplayer("playerTarget").setup(
        {
            playlist:
            [{
            ...
            advertising: advert,
            skin: "http://az332173.vo.msecnd.net/scripts/jwp/skins/glow.xml"
            , clipBegin: start
            , clipEnd: end
        ...
        jwp.onReady(function () {
            ...
            $("#watch-later").click(function () {
                ...
                if (jwp.getState().toUpperCase() === "IDLE") {
                    ...
                    streamComscore.notify(ns_.StreamSense.PlayerEvents.END, { ns_st_ui: "stop" }, ((typeof jwp.getPosition() != 'undefined') ? parseInt(jwp.getPosition()) : 0));
                }
                return false;
            });
        })
        ...
        .onSeek(function (e) {
            ...
            streamComscore.notify(ns_.StreamSense.PlayerEvents.PAUSE, { ns_st_ui: "seek" }, ((typeof jwp.getPosition() != 'undefined') ? parseInt(jwp.getPosition()) : 0));
        })
        .onPlay(function (e) {
            ...
            if (initial && jwpObj.lastpos == 0) {
                ...
                streamComscore.notify(ns_.StreamSense.PlayerEvents.PLAY, {}, ((typeof this.getPosition() != 'undefined') ? this.getPosition() : 0));
                initial = false;
            }
            else {
                ...
                streamComscore.notify(ns_.StreamSense.PlayerEvents.PLAY, { ns_st_ui: "resume" }, ((typeof jwp.getPosition() != 'undefined') ? parseInt(jwp.getPosition()) : 0));
            }
            ...
            if (initializeScripts) {
                ...
                $(window).unload(function () {
                    $.post('/Ajax/LogPlayback', { type: 1, id: jwpObj.EpisodeId, playTypeId: _STOP, fullDuration: parseInt(jwp.getDuration()), isPreview: jwpObj.preview, positionDuration: parseInt(jwp.getPosition()), streamType: streamType, bufferCount: bufferCount, minBandwidth: parseInt(minBandwidth), maxBandwidth: parseInt(maxBandwidth), avgBandwidth: parseInt(totalBandwidth / bwCount) }, function (data) { });
                    streamComscore.notify(ns_.StreamSense.PlayerEvents.END, { ns_st_ui: "browser_close" }, ((typeof jwp.getPosition() != 'undefined') ? parseInt(jwp.getPosition()) : 0));
                });
        ...
        .onPause(function () {
            ...
            streamComscore.notify(ns_.StreamSense.PlayerEvents.PAUSE, {}, ((typeof jwp.getPosition() != 'undefined') ? parseInt(jwp.getPosition()) : 0));
        })
        .onComplete(function (e) {
            if (err === false) {
                ...
                streamComscore.notify(ns_.StreamSense.PlayerEvents.END, {}, ((typeof jwp.getPosition() != 'undefined') ? parseInt(jwp.getPosition()) : 0));
                completed = true;
            }
            else
        ...
        .onBuffer(function () {
            ...
            streamComscore.notify(ns_.StreamSense.PlayerEvents.BUFFER, { ns_st_ui: "buffer" }, ((typeof jwp.getPosition() != 'undefined') ? parseInt(jwp.getPosition()) : 0));
        })
        .onMeta(function (e) {
            if (streamType === 0) {
